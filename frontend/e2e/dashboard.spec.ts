      ...
      await route.fulfill({
        ...
        body: JSON.stringify({
          ...
          tokens: [
            ...
            { id: 102, text: 'world', position: 1, isWord: true, toBeNormalized: true, candidates: ['World'] },
          ],
        }),
      });
    });
    ...
    await page.route('**/api/texts/1', async route => {
      await route.fulfill({
        ...
        body: JSON.stringify({
          ...
          normalizedByUser: false,
          assignedToUser: true,
          tokens: [{ id: 101, text: 'Hello', position: 0, isWord: true, toBeNormalized: false, candidates: [] }],
        }),
      });
    });
