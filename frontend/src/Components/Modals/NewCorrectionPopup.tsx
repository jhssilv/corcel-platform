...
const NewCorrectionPopup = ({
	...
	const tokenText =
		selectedFirstIndex !== null ? (tokens[selectedFirstIndex]?.text ?? "") : "";
			...
			>
				...
				>
					<p className={styles.dialogText}>
						...
						você deseja remover a correção?
					</p>
		...
		>
			...
			>
				<p className={styles.dialogText}>
					...
					{suggestForAll
						? ` para todas as ocorrências de "${tokenText}"? Isso afetará todos os textos`
						: "?"}
				</p>
				<DialogFooter align="center">
					<Button
