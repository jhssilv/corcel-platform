...
import type {
	SnackbarMessage,
	SnackbarPosition,
} from "../../../Context/Generic/Notifications/SnackbarContext";
...
export default function SnackbarContainer({
	...
	return (
		<>
			{(Object.keys(positionedSnackbars) as SnackbarPosition[]).map(
				(position) => {
					...
					return (
						<div
							key={position}
							className={`${styles["snackbar-container"]} ${styles[position]}`}
						>
							{group.map((snackbar) => (
								<Snackbar
									key={snackbar.id}
