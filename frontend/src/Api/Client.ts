...
const handleBlobSuccess = (
	response: AxiosResponse<Blob>,
): AxiosResponse<Blob> => response;

const handleBlobError = async (
	error: AxiosError<Blob | ApiErrorPayload>,
): Promise<never> => {
	...
	return Promise.reject({
		error: "Connection error or invalid response for blob request.",
	});
};
